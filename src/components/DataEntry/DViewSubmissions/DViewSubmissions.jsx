...
const DViewSubmissions = () => {
  ...
  const fetchTaxpayer = async (userId) => {
    try {
      const res = await axios.get(
        `${base_url}/api/SuperAdmin/fetchTaxpayer/${userId}`
      );
  ...
  const updateSubmissionStatusBusinessIncome = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusBusinessIncome/${incomeId}`
      );
  ...
  const updateSubmissionStatusEmploymentIncome = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusEmploymentIncome/${incomeId}`
      );
      window.location.reload();
    } catch (err) {
      console.log(err);
  ...
  const updateSubmissionStatusInvestmentIncome = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusInvestmentIncome/${incomeId}`
      );
      window.location.reload();
    } catch (err) {
      console.log(err);
  ...
  const updateSubmissionStatusOtherIncome = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusOtherIncome/${incomeId}`
      );
      window.location.reload();
    } catch (err) {
      console.log(err);
  ...
  const updateSubmissionStatusreliefForExpenditure = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusreliefForExpenditure/${incomeId}`
      );
      window.location.reload();
    } catch (err) {
      console.log(err);
  ...
  const updateSubmissionStatusCapitalValueGain = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusCapitalValueGain/${incomeId}`
      );
      window.location.reload();
    } catch (err) {
      console.log(err);
  ...
  const updateSubmissionStatusReliefForRentIncome = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusReliefForRentIncome/${incomeId}`
      );
      window.location.reload();
    } catch (err) {
      console.log(err);
  ...
  const updateSubmissionStatusQualifyingPayments = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusQualifyingPayments/${incomeId}`
      );
      window.location.reload();
    } catch (err) {
      console.log(err);
  ...
  const updateSubmissionStatusTerminalBenefits = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusTerminalBenefits/${incomeId}`
      );
      window.location.reload();
    } catch (err) {
      console.log(err);
  ...
  const updateSubmissionStatusWhtOnInvestmentIncome = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusWhtOnInvestmentIncome/${incomeId}`
      );
      window.location.reload();
    } catch (err) {
      console.log(err);
  ...
  const updateSubmissionStatusWhtOnServiceFeeReceived = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusWhtOnServiceFeeReceived/${incomeId}`
      );
      window.location.reload();
    } catch (err) {
      console.log(err);
  ...
  const updateSubmissionStatusWhtWhichIsNotDeducted = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusWhtWhichIsNotDeducted/${incomeId}`
      );
      window.location.reload();
    } catch (err) {
      console.log(err);
  ...
  const updateSubmissionStatusApit = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusApit/${incomeId}`
      );
      window.location.reload();
    } catch (err) {
      console.log(err);
  ...
  const updateSubmissionStatusSelfAssessmentPayment = async (incomeId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateSubmissionStatusSelfAssessmentPayment/${incomeId}`
      );
      window.location.reload();
    } catch (err) {
      console.log(err);
  ...
  const updateNoOfSubmissions = async (userId) => {
    try {
      await axios.put(
        `${base_url}/api/SuperAdmin/updateNoOfSubmissions/${userId}`
      );
    } catch (error) {
                        ...
                        >
                          <div style={{ width: "55%" }}>
                            <button className="custom-button-2">
                              <div>
                                ...
                                {income.isverified ? (
                                  <Badge className="badge-2" bg="primary">
                                    verified
                                  </Badge>
                                ) : (
                                  <Badge className="badge-2" bg="danger">
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={() => {
                                downloadDocument(income.filePath);
                                updateSubmissionStatusBusinessIncome(
                                  income.incomeId
                                );
                                if (income.isnewsubmission) {
                        ...
                        >
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={() => {
                                downloadDocument(income.filePath);
                                updateSubmissionStatusEmploymentIncome(
                                  income.incomeId
                                );
                                if (income.isnewsubmission) {
                                  updateNoOfSubmissions(userId);
                        ...
                        >
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={() => {
                                downloadDocument(income.filePath);
                                updateSubmissionStatusInvestmentIncome(
                                  income.incomeId
                                );
                                if (income.isnewsubmission) {
                                  updateNoOfSubmissions(userId);
                        ...
                        >
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={() => {
                                downloadDocument(income.filePath),
                                  updateSubmissionStatusReliefForRentIncome(
                                    income.reliefid
                                  );
                                if (income.isnewsubmission) {
                                  updateNoOfSubmissions(userId);
                        ...
                        >
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={() => {
                                downloadDocument(income.filePath);
                                updateSubmissionStatusOtherIncome(
                                  income.incomeId
                                ),
                                  updateNoOfSubmissions(userId);
                                if (income.isnewsubmission) {
                        ...
                        >
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={(event) => {
                                downloadDocument(income.filePath),
                                  updateSubmissionStatusreliefForExpenditure(
                                    income.reliefid
                                  );
                                if (income.isnewsubmission) {
                                  updateNoOfSubmissions(userId);
                        ...
                        >
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={() => {
                                downloadDocument(income.filePath),
                                  updateSubmissionStatusQualifyingPayments(
                                    income.reliefid
                                  );
                                if (income.isnewsubmission) {
                                  updateNoOfSubmissions(userId);
                        ...
                        >
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={() => {
                                downloadDocument(income.filePath),
                                  updateSubmissionStatusApit(income.APITId);
                                if (income.isnewsubmission) {
                                  updateNoOfSubmissions(userId);
                                }
                              }}
                        ...
                        >
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={() => {
                                downloadDocument(income.filePath),
                                  updateSubmissionStatusWhtOnServiceFeeReceived(
                                    income.taxCreditId
                                  );
                                if (income.isnewsubmission) {
                                  updateNoOfSubmissions(userId);
                        ...
                        >
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={() => {
                                downloadDocument(income.filePath),
                                  updateSubmissionStatusWhtOnInvestmentIncome(
                                    income.taxCreditId
                                  );
                                if (income.isnewsubmission) {
                                  updateNoOfSubmissions(userId);
                        ...
                        >
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={() => {
                                downloadDocument(income.filePath),
                                  updateSubmissionStatusSelfAssessmentPayment(
                                    income.taxCreditId
                                  );
                                if (income.isnewsubmission) {
                                  updateNoOfSubmissions(userId);
                        ...
                        >
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={() => {
                                downloadDocument(income.filePath),
                                  updateSubmissionStatusTerminalBenefits(
                                    income.assessmentId
                                  );
                                if (income.isnewsubmission) {
                                  updateNoOfSubmissions(userId);
                        ...
                        >
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={() => {
                                downloadDocument(income.filePath),
                                  updateSubmissionStatusCapitalValueGain(
                                    income.assessmentId
                                  );
                                if (income.isnewsubmission) {
                                  updateNoOfSubmissions(userId);
                        ...
                        >
                          ...
                          <div style={{ width: "10%" }}>
                            <button
                              ...
                              onClick={() => {
                                downloadDocument(income.filePath),
                                  updateSubmissionStatusWhtWhichIsNotDeducted(
                                    income.assessmentId
                                  );
                                if (income.isnewsubmission) {
                                  updateNoOfSubmissions(userId);
...
export default DViewSubmissions;
