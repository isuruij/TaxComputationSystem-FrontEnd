  ...
  return (
    <div>
        <div style={{margin:"40px"}}>
            ...
            <div> <button type="button" className="btn btn-success" style={{margin:"10px" , width:"150px"}}onClick={() => {navigate("/SuperAdminDashboard")}}><img src={sent} alt="" style={{width:"27px", marginRight:"10px"}} /> Sent</button></div> 
        </div>
    </div>
  )
}
